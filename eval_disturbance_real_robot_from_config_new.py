                ...
                while True:
                    ...
                    if not skip_this_cycle:
                        ...
                        if disturbance_active:
                            disturbance_pos, disturbance_vel = env.exec_perturbed_actions(
                                actions=[action], 
                                timestamps=[t_command_target-time.monotonic()+time.time()],
                                disturbance_vel=disturbance_vel,
                                disturbance_pos=disturbance_pos,
                                disturbance_rng=drng,
                                disturbance_func=propagate_disturbance,
                                stages=None,
