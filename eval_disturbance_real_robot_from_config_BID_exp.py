...
def main(config, input, bad_checkpoint, output, robot_ip, tool_address, ft_sensor_ip, tool_init_pos, match_dataset, match_episode, vis_camera_idx, steps_per_inference, max_duration, frequency, command_latency, disturbance_seed):
    ...
    if 'ctm' in cfg.name:
        ...
        bad_policy = get_policy(bad_checkpoint)
    ...
    bad_policy.num_inference_steps = 2
            ...
            while True:
                ...
                try:
                    ...
                    while True:
                        ...
                        "her står det precise_wait(t_cycle_end) i DP config"
