...
def test():
    ...
    serial = serials[0]
    config = json.load(open('diffusion_policy/real_world/realsense_config/435_high_accuracy_mode.json', 'r'))
    ...
    with SharedMemoryManager() as shm_manager:
        with SingleRealsense(
            ...
            while True:
                ...
                image_path = os.path.join(os.path.dirname(current_dir), "captured_image.jpg")
